...
class UserProfile(models.Model):
    ...
    User Profile code supplied by Code Institute
    """
    ...
    default_town_or_city = models.CharField(max_length=50,
                                            null=True, blank=True)
    default_county = models.CharField(max_length=50,
                                      null=True, blank=True)
...
def create_or_update_user_profile(sender, instance, created, **kwargs):
    ...
    create_or_update_user_profile code supplied by Code Institute
    """
    if created:
