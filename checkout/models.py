...
class Order(models.Model):
    """
    Model class to hold order details
    Order model supplied by Code Institute
    """
    ...
    def __str__(self):
        """
        Override string method and return order number
        """
...
class OrderLineItem(models.Model):
    """
    Model class to hold order line item details
    Order Line Item model supplied by Code Institute
    """
    ...
    def __str__(self):
        """
        Override the str method and return sku comment
        """
