...
def checkout(request):
    """
    Code to save ording information in the event of a successful
    payment
    checkout code supplied by Code Institute
    """
            ...
            for item_id, item_data in basket.items():
                try:
                    ...
                    messages.error(request, (
                        "One of the plants in your basket "
...
#     checkout_success code supplied by Code Institute
#     """
